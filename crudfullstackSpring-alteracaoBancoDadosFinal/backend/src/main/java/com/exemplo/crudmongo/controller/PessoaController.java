...
public class PessoaController {
    ...
    public List<Pessoa> listar() {
     ...
     // Busca por nome (exemplo: /pessoas/buscar-por-nome?nome=Joao)
    @GetMapping("/buscar-por-nome")
    public List<Pessoa> buscarPorNome(@RequestParam String nome) {
        return service.buscarPorNome(nome);
    }

    // Busca por idade (exemplo: /pessoas/buscar-por-idade?idade=30)
    @GetMapping("/buscar-por-idade")
    public List<Pessoa> buscarPorIdade(@RequestParam int idade) {
