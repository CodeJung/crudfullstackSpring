...
@RestController
@RequestMapping("/api/cursos/coordenador")
@CrossOrigin(origins = "*")
public class CursoControllerCoordenador {

private final CursoService service;

public CursoControllerCoordenador(CursoService service) {
