...
@RestController
@RequestMapping("/api/cursos/cordenador")
@CrossOrigin(origins = "*")
public class CursoControllerCordenador {


    //mesmo erro do model//
    //versao do chat com modificacoes//
    private final CursoService service;

    public CursoControllerCordenador(CursoService service) {
